...
'''
numpyXOR.py
Neural net using numpy matrix operations, trains on and classifies the XOR function
Justin Kahr
'''
...
# XOR function
XORin = [[1,0],[0,0],[1,1],[0,1]]
XORout = [[1],[0],[0],[1]]
# Train the agent
test_agent.train_net(XORin, XORout, max_sse = 0, max_num_epoch=test_agent.max_epoch)
